...
const steps = [
  ...
  {
    title:
      'Export reads whatever the table is currently showing, not a separate field list',
    description:
  ...
  {
    title:
      'Excel export is an HTML table with an .xls extension, not a real spreadsheet file',
    description:
      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-base text-muted-foreground text-balance">
            ...
            currently showing, and a print-optimized view that ignores dark mode
            entirely.
          </p>
        </div>
